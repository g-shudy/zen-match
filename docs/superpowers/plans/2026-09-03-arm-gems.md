...
Run: `node build.mjs --test && node --test tests/engine.test.js`
Expected: every engine test passes (19 original minus 1 deleted, plus 5 from Task 1, plus 12 new = 35).
...
Run: `npm test`
Expected: storage tests pass (9); engine and palette tests pass; total 47.
...
Run: `npm test`
Expected: 50 tests pass (47 plus the 3 new).
...
Expected: clean, 50 tests pass, version `2.1.0`.
